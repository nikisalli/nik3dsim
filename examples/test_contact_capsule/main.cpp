...
int main() {
    ...
    add_rigidbody(&m, BODY_CAPSULE, (float[]){0.4f, 1.0f, 0.0f}, 1.0f, (float[]){0.5, 0, 10.0f}, (float[]){0, M_PI / 2, 0}, 0.001f, 0.0f, 1, 1);
    add_staticbody(&m, BODY_AXIS_ALIGNED_BOX, (float[]){1.0f, 1.0f, 1.0f}, (float[]){2, 0, 5}, (float[]){0, 0, 0}, 0.001f, 0.0f, 1, 1);
