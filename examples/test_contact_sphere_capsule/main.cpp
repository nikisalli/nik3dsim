...
int main() {
    ...
    add_rigidbody(&m, BODY_SPHERE, (float[]){0.5f, 0.0f, 0.0f}, 1.0f, (float[]){0, 0, 10.0f}, (float[]){0, 0, 0}, 0.001f, 0.5f, 1, 1);
    add_staticbody(&m, BODY_CAPSULE, (float[]){0.3f, 2.0f, 0.0f}, (float[]){0.0f, 0.0f, 0.0f}, (float[]){0, M_PI * 0.25, 0}, 0.001f, 0.0f, 1, 1);
