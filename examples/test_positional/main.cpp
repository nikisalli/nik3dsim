...
int main() {
    ...
    simulator_init(
        ...
        1000          // More iterations for constraint stability
    );
    
    // Create first cube
    RigidBody body1;
    niknum size1[3] = {1.0f, 1.0f, 1.0f};     // Unit cube
    niknum pos1[3] = {-1.5f, 0, 0};           // Positioned left of origin
    ...
    // Create second cube
    RigidBody body2;
    niknum size2[3] = {1.0f, 1.0f, 10.0f};     // Unit cube
    niknum pos2[3] = {1.5f, 0, 0};            // Positioned right of origin
    ...
    PositionalConstraint pos_constraint;
    
    // Set attachment points at the facing corners of the cubes
    niknum local_pos0[3] = {0.5f, 0.5f, 0.5f};   // Right-top-front corner of body1
    niknum local_pos1[3] = {5.0f, 0.5f, 0.5f};  // Left-top-front corner of body2
    
    // Initialize the constraint with some compliance for a slightly soft connection
    pos_constraint.compliance = 0.1f;
