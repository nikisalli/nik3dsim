...
int main() {
    nikModel m;
    nikData d;
    simulator_init(&m, (float[]){0, 0, -9.81}, 0.01f, 1, 0.1f);

    add_rigidbody(&m, BODY_SPHERE, (float[]){0.5f, 0.5f, 0.5f}, 1.0f, (float[]){1, 0, 3.0f}, (float[]){0, 0, 0}, 0.0f, 1000.0f, 1, 1);
    add_rigidbody(&m, BODY_CAPSULE, (float[]){0.5f, 2.0f, 0.5f}, 1.0f, (float[]){3, 0, 3.0f}, (float[]){M_PI / 2, 0, 0}, 0.0f, 1.0f, 1, 1);
