...
int main() {
    ...
    add_rigidbody(&m, BODY_SPHERE, (float[]){1.0f, 0.0f, 0.0f}, 1.0f, (float[]){0, 0, 10.0f}, (float[]){0, 0, 0}, 0.001f, 100.0f, 1, 1);
    add_staticbody(&m, BODY_SPHERE, (float[]){1.0f, 0.0f, 0.0f}, (float[]){0.05, 0, 0}, (float[]){0, -M_PI * 0.4, 0}, 0.001f, 0.0f, 1, 1);
