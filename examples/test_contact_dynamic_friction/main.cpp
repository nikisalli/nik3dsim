...
int main() {
    ...
    add_rigidbody(&m, BODY_BOX, (float[]){0.5f, 0.5f, 0.5f}, 1.0f, (float[]){1, 0, 0.5f}, (float[]){0, M_PI / 2, 0}, 0.001f, 10.0f, 1, 1);
    add_rigidbody(&m, BODY_BOX, (float[]){0.5f, 0.5f, 0.5f}, 1.0f, (float[]){1, 3, 0.5f}, (float[]){0, M_PI / 2, 0}, 0.001f, 0.2f, 1, 1);
    add_rigidbody(&m, BODY_BOX, (float[]){0.5f, 0.5f, 0.5f}, 1.0f, (float[]){1, 6, 0.5f}, (float[]){0, M_PI / 2, 0}, 0.001f, 0.1f, 1, 1);
    add_rigidbody(&m, BODY_BOX, (float[]){0.5f, 0.5f, 0.5f}, 1.0f, (float[]){1, 9, 0.5f}, (float[]){0, M_PI / 2, 0}, 0.001f, 0.0f, 1, 1);
